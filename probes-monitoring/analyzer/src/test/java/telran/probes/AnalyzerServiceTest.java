...
class AnalyzerServiceTest {
	...
	private static final Range RANGE1 = new Range(MIN_VALUE + 10, MAX_VALUE + 10);
	@Autowired
...
RestTemplate restTemplate;
	...
	void defaultRangeNotInCache() {
		ResponseEntity<Range> responseEntity = new ResponseEntity<>(RANGE, HttpStatus.OK);
		when(restTemplate.exchange(getUrl(SENSOR_ID_NEW), HttpMethod.GET, null, Range.class))
		.thenReturn(responseEntity );
		assertEquals(RANGE, providerService.getRange(SENSOR_ID_NEW));
	}
